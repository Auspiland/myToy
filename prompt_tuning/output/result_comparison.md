...
1. [결과 0](#결과-0): 당신은 코드 요약 전문가입니다....
2. [결과 2](#결과-2): You are a professional reviewer of code....
3. [결과 3](#결과-3): You are a professional reviewer of code....
4. [결과 4](#결과-4): You are a professional reviewer of code....
...
- **Arguments**:
  - file_path: `C:\Users\T3Q\jeonghan\my_github\myToy\prompt_tuning\data\rect2region_fast_v2.py`
...
| ID | System Prompt | User Prompt | Task |
|---|---|---|---|
| 0 | 당신은 코드 요약 전문가입니다.... | 다음 코드를 요약해주세요.... | summarize python code |
| 2 | You are a professional reviewer of code.... | Summary the following code.... | summarize python code |
| 3 | You are a professional reviewer of code.... | Summary the following code in Korean.... | summarize python code |
| 4 | You are a professional reviewer of code.... | Summary the following code. After summarizing, tra... | summarize python code |

### 답변 길이 비교

| ID | 답변 길이 (글자) | 답변 길이 (단어) |
|---|---|---|
| 0 | 3,172 | 451 |
| 2 | 6,190 | 758 |
| 3 | 3,215 | 493 |
