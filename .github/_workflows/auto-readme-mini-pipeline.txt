name: Auto Update Mini-Pipeline README

on:
  schedule:
    - cron: "0 3 * * *"      # 매일 12:00 KST = 03:00 UTC
    - cron: "0 10 * * *"     # 매일 19:00 KST = 10:00 UTC
...
env:
  TARGET_DIR: "Mini-Pipeline"
  README_PATH: "Mini-Pipeline/README.md"
  ...
  update-readme:
    ...
    steps:
      ...
      - name: Run updater
        ...
        run: |
          python .github/scripts/update_readme_mini_pipeline.py \
      ...
      - name: Commit & Push if changed
        run: |
          if [[ -n "$(git status --porcelain)" ]]; then
            ...
            git add -A
            git commit -m "chore(Mini-Pipeline): auto-update README via LLM [skip ci]"
            git push
          else
